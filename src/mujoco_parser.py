...
class MuJoCoParserClass(object):
    ...
    def init_viewer(self, viewer_title='MuJoCo', viewer_width=1200, viewer_height=800, viewer_hide_menus=True):
        """
        Initialize viewer with interactive camera control.
        """
        ...
        self.viewer.cam.fixedcamid = -1  # Use the free camera (not fixed to any body)
        self.viewer.cam.distance = 2.0  # Initial camera distance
        self.viewer.cam.azimuth = 45.0  # Initial camera azimuth angle
        self.viewer.cam.elevation = -30.0  # Initial camera elevation angle
    ...
    def update_viewer(self,azimuth=None,distance=None,elevation=None,lookat=None,
                      ...
                      VIS_JOINT=None,jointlength=None,jointwidth=None,jointrgba=None, cam_id=None):
        ...
        if cam_id is not None:
            ...
            if self.viewer.is_alive:
                ...
                if key == ord('r'):  # Reset camera to default view
